...
- 1 plain whole wheat roti/chapati (no oil) ≈ 70-80 kcal, 3g protein, 15g carbs, 0.5g fat, 2-3g fiber
- 1 butter/ghee roti ≈ 100-110 kcal
- 1 plate biryani or rice ≈ 350g
- Also accept g, gram, kg, ml, l, liter, mg, pieces, plate, katori, bowl, cup, roti, chapati, sabzi, dal, paneer, eggs.

Estimate typical Indian meal micronutrients and dietary fiber accurately from common preparations (roti, dal, sabzi, paneer, eggs, chicken, milk, rice).
Return calories, protein (g), carbs (g), fat (g), fiber (g), and micros:
iron_mg, calcium_mg, magnesium_mg, zinc_mg, vitamin_d_iu, vitamin_b12_mcg.

Use realistic cooked-food values, not raw USDA-only numbers. Whole wheat roti, dals, and leafy sabzis are high in fiber; dairy and eggs contribute calcium, vitamin D, and B12; dals and spinach contribute iron.
